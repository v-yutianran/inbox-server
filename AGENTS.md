...
This project is indexed by GitNexus as **inbox-server** (2034 symbols, 3111 relationships, 90 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
