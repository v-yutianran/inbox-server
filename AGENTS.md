...
This project is indexed by GitNexus as **inbox-server** (2476 symbols, 3894 relationships, 113 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
