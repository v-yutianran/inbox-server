...
This project is indexed by GitNexus as **inbox-server** (3322 symbols, 5920 relationships, 191 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
