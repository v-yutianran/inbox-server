...
This project is indexed by GitNexus as **inbox-server** (3513 symbols, 6215 relationships, 196 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
