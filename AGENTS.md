...
This project is indexed by GitNexus as **inbox-server** (1391 symbols, 2110 relationships, 66 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
